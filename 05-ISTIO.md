...
helm upgrade --install kiali-1-17-0 kiali/kiali-server \
  ...
  --set external_services.istio.component_status.components[0].app_label=istio-egress-gateway-1-17-0 \
  ...
  --set external_services.istio.component_status.components[1].app_label=istio-ingress-gateway-1-17-0 \
  --set external_services.istio.component_status.components[1].is_core=true \
  --set external_services.istio.component_status.components[1].is_proxy=true \
  --set external_services.istio.component_status.components[1].namespace=istio-gateway-system \
  \
...
helm upgrade --install kiali-1-17-2 kiali/kiali-server \
  ...
  --set kiali_feature_flags.istio_upgrade_action=true \
  --set external_services.istio.component_status.enabled=true \
  --set external_services.istio.component_status.components[0].app_label=istio-egress-gateway-1-17-2 \
  --set external_services.istio.component_status.components[0].is_core=true \
  --set external_services.istio.component_status.components[0].is_proxy=true \
  --set external_services.istio.component_status.components[0].namespace=istio-gateway-system \
  --set external_services.istio.component_status.components[1].app_label=istio-ingress-gateway-1-17-2 \
  --set external_services.istio.component_status.components[1].is_core=true \
  --set external_services.istio.component_status.components[1].is_proxy=true \
  --set external_services.istio.component_status.components[1].namespace=istio-gateway-system \
